...
**TypeArchy v08 ** is a free Adobe Illustrator script that generates modular type scales directly on your artboard — with named levels (H1–H5, XL, Base, Small), a local font browser, and optional CSS output.

Typography has hierarchy. TypeArchy makes it visual.
![TypeArchy Preview](preview.png)
